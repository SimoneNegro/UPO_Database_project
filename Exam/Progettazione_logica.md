...
- Utente
    ...
    Utente(mail, nome, cognome, immagineProfilo, nickname, password, dataNascita, Cellulare, Bit, DataRegistrazione, premium, streamer, numLive, minTrasmessi, NumMediaSpect, Affiliate, utenteFragile, disabilità)
    ...
    CREATE TABLE Utente (
        ...
        Password VARCHAR(255) NOT NULL, -- Assicurati di implementare la sicurezza delle password, ad esempio, usando l'hashing.
    ...
    select mail, dataRegistrazione from utente where premium = true;
...
- Abbonamento
    ...
    Abbonamento(dataInizio, dataFine, *mailUtente*)
...
- Canale
    ...
    Canale(id, descrizione, immagineProfilo, trailer, dataCreazione, *mailStreamer*)
...
- Live
    ...
    Live(id, titolo, descrizione, live, dataOraInizio, dataOraFine, numMediaSpect, tipologia, *idCanale*, *idStramer*)
...
- Contenuto
    ...
    Contenuto(id, titolo, durata, categorie, tipo, numeroVisual, dataRilascio, likert, accessibile, *idLive*)
...
- Admin
    ...
    Admin(mail, nickname, nome, cognome, password)
    ...
    CREATE TABLE Admin (
        ...
        Nome VARCHAR(255) NOT NULL,
        Cognome VARCHAR(255) NOT NULL,
        Password VARCHAR(255) NOT NULL -- Dovresti applicare la crittografia o l'hashing per la sicurezza della password
    );
...
- Reazione
    ...
    Reazione(dataOra, *mailUtente*, *idLive*, reazione, tipo)
...
- Commento
    ...
    Commento(dataOra, *mailUtente*, *idLive*, commento)
...
- MessaggioPrivato
    ...
    MessaggioPrivato(id, testo, dataInvio, contenutoMultimediale, *mailMittente*, *mailDestinatario*)
...
- Sub
    ...
    Sub(Id, tipo, prezzo, data, *mailUtente*, *idCanale*)

    ```sql
    CREATE TABLE Sub (
        Id SERIAL PRIMARY KEY,
        Tipo VARCHAR(255) NOT NULL, -- Puoi regolare la lunghezza in base alle tue esigenze
        Prezzo DECIMAL(10, 2) NOT NULL, -- DECIMAL con precisione 10 e 2 decimali
...
- Dona_a
    ...
    dona_a(*mailUtente*, *mailStreamer*, bit)
...
- VisulizzaEsclusiva
    ...
    visualizzaEsclusiva(*mailUtente*, *idLive*)
...
- Ha_accesso
    ...
    ha_accesso(*idContenutoAccessibile*, *mailUtenteFragile*)
...
- Associato
    ...
    associato(*idCanale*, *nomeSocial*, link)
...
- Commenta
    ...
    Commenta(*mail_utente*, *id_contenuto*, dataOraInvio, commento)
...
- CREATE
    ...
    [DDL.sql](/Exam/SQL_Files/DDL.sql)

- INSERT

    [DMLPOP](/Exam/SQL_Files/DMLPOP.sql)

- UPDATE

    [DMLUPD.sql](/Exam/SQL_Files/DMLUPD.sql)
